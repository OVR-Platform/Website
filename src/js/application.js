...
flktyTimeline.select(this.dataset.index);});});}};var menuManager=function menuManager(){window.removeEventListener("scroll",menuManagerOnScroll,false);window.addEventListener("scroll",menuManagerOnScroll,false);function menuManagerOnScroll(){var hero=(0,_util.$1)(".c-hero");var body=(0,_util.$1)("body");var pageWrap=(0,_util.$1)("#page-wrap");var heroHeight=hero.offsetHeight;var scrollTop=window.pageYOffset||document.documentElement.scrollTop;// console.log(scrollTop);
// console.log(heroHeight);
// console.log(footerOffset);
// pageWrap menu
if(scrollTop>heroHeight-500){pageWrap.classList.add("is-scrolling");}else{pageWrap.classList.remove("is-scrolling");}// if ( scrollTop > 0 && !mouseOverMenu ){
...
}};var init=function init(){startParallax();initCarousels();menuManager();console.log('init');};return{init:init};}();exports.default=Application;

},{"./util":21,"flickity":9,"smooth-parallax":16}],21:[function(require,module,exports){
